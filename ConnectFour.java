...
public class ConnectFour {
	...
	private static Boolean checkArgs(String[] args) {
		if (args.length == 1 && Integer.parseInt(args[0]) > 3) { // fixed unexpected tie defect by simply forbidding any number less than 4
			return true;
		}
		return false;
	}
	...
	private static void showUsageAndExit() {
		...
		System.out.println("*x* should be a nonnegative integer greater than 3");
		System.exit(1);
	}
}